     ...
     x-data="(function() {
        return {
            ...
            init() {
                ...
                container.addEventListener('dragenter', () => { this.dragOver = true; }, false);
                container.addEventListener('dragleave', (e) => {
                    if (e.target === container || e.target === this.$el.querySelector('.photo-drop-overlay')) {
                        this.dragOver = false;
                    }
                }, false);
            }
    ...
    <div class="photo-field-grid">
        <template x-for="(item, index) in displayItems" :key="item.id">
            <div class="photo-item">
                ...
                <template x-if="isMultiple && index === 0 && item === items[0]">
